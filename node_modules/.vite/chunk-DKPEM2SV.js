...
function useTheme4(defaultTheme = systemDefaultTheme) {
...
var React17, import_prop_types9, import_jsx_runtime4, _excluded4;
    ...
    const muiStyledResolver = (styleArg, ...expressions) => {
      const expressionsWithDefaultTheme = expressions ? expressions.map((stylesArg) => {
        return typeof stylesArg === "function" && stylesArg.__emotion_real !== stylesArg ? (_ref) => {
          ...
          return stylesArg(_extends({
            theme: isEmpty3(themeInput) ? defaultTheme : themeInput
          }, other));
        } : stylesArg;
      }) : [];
      ...
      if (componentName && overridesResolver) {
        expressionsWithDefaultTheme.push((props) => {
          const theme = isEmpty3(props.theme) ? defaultTheme : props.theme;
...
var init_cssVarsParser = __esm({
  "node_modules/@mui/system/esm/cssVars/cssVarsParser.js"() {
    assignNestedKeys = (obj, keys, value) => {
      let temp = obj;
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    } = baseTheme, restBaseTheme = _objectWithoutPropertiesLoose(baseTheme, _excluded7);
    const {
      colorSchemes: colorSchemesProp = {}
    } = themeProp, restThemeProp = _objectWithoutPropertiesLoose(themeProp, _excluded23);
...
var React21, import_prop_types11, import_jsx_runtime7, import_jsx_runtime8, _excluded7, _excluded23, _excluded33, DISABLE_CSS_TRANSITION;
var init_createCssVarsProvider = __esm({
  "node_modules/@mui/system/esm/cssVars/createCssVarsProvider.js"() {
    ...
    _excluded7 = ["colorSchemes"];
    _excluded23 = ["colorSchemes"];
    _excluded33 = ["components"];
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-DKPEM2SV.js.map
